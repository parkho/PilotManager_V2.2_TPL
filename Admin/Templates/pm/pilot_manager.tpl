...
<div style="border-radius: 10px;" class="FlightInformation">
 ...
 <div style="height: 100%; border-radius: 10px;" class="content_holder">
  <div id="pi"><?php Template::show('pm/pilot_information.tpl');?></div>
  <div id="se"><?php Template::show('pm/send_email.tpl');?></div>
  <div id="dp"><?php Template::show('pm/edit_pilots.tpl');?></div>
 </div>
</div>
